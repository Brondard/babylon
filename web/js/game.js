...
Game = function(canvasId) {
    ...
    engine.runRenderLoop(function() {
        ...
        //// NE PAS METTRE LE RENDER APRES LE LAUNCH FIRE
        //// LA TRAJECTOIRE DE LA BALLE EST CALCULEE APRES QUE LA SCENE SOIT REDESSINEE

        // Si launchBullets est a true, on tire
        if (_player.camera.armes.launchBullets === true) {
            _player.camera.armes.launchFire();
        }
    });
